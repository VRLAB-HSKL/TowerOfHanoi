...
public class ColliderPoleB : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.gameObject.name == "Disc3") { 
            Vector3 newCoords = GameObject.Find("ToH").GetComponent<GameToH>().getPoleBposition(2);
            GameObject.Find("ToH").GetComponent<GameToH>().getSpecificPoleBPositions();
        ...
        {
            Vector3 newCoords = GameObject.Find("ToH").GetComponent<GameToH>().getPoleBposition(1);
            GameObject.Find("ToH").GetComponent<GameToH>().getSpecificPoleBPositions();
            newCoords.x = newCoords.x + 10f;
            newCoords.z = newCoords.z + 10f;
            other.gameObject.transform.position = newCoords;
        ...
        {
            Vector3 newCoords = GameObject.Find("ToH").GetComponent<GameToH>().getPoleBposition(0);
            GameObject.Find("ToH").GetComponent<GameToH>().getSpecificPoleBPositions();
            newCoords.x = newCoords.x + 10f;
            newCoords.z = newCoords.z + 10f;
            other.gameObject.transform.position = newCoords;
